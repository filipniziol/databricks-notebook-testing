...
# MAGIC %md
# MAGIC # Load Hand History to Bronze
# MAGIC Load raw hand history text files using Auto Loader.
# MAGIC 
# MAGIC **Source:** `/Volumes/poker/bronze/bronze/gg_hand_history/`  
# MAGIC **Target:** `poker.bronze.hand_history`
...
# Configuration
SOURCE_PATH = "/Volumes/poker/bronze/bronze/gg_hand_history/"
TARGET_TABLE = "poker.bronze.hand_history"
CHECKPOINT_PATH = "/Volumes/poker/bronze/bronze/_checkpoints/hand_history"
...
def load_hand_history():
    """
    Stream hand history files from volume to bronze table.
